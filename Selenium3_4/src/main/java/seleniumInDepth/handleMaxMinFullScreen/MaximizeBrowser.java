package seleniumInDepth.handleMaxMinFullScreen;
...
public class MaximizeBrowser {
	...
	public static void main(String[] args) {
		...
		driver.manage().window().maximize(); // Method chaining & Maximizes the current window if it is not already maximized
